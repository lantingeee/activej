...
public final class RemoteActiveFs implements ActiveFs, EventloopService, EventloopJmxBeanEx {
	...
	public static final FsException INVALID_MESSAGE = new FsException(RemoteActiveFs.class, "Invalid or unexpected message received");
	public static final FsException UNKNOWN_SERVER_ERROR = new FsException(RemoteActiveFs.class, "Unknown server error occurred");
